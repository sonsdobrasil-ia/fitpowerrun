...
## 5. Dados
- [ ] Executar \`data.sql\` (ou importar os CSVs) na ordem: ebooks, plans, profiles, user_roles, subscribers, workout_logs, ebook_reading_progress, payment_webhook_events.
